...
/**
 * This is the item provider adapter for a {@link simplePalladio.AssemblyViewPoint.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider extends InterfaceCommunicatorItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AssemblyViewPointPackage.Literals.SYSTEM__SYSTEM_ELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(AssemblyViewPointPackage.Literals.SYSTEM__SYSTEM_ELEMENTS,
				AssemblyViewPointFactory.eINSTANCE.createAssemblyContext()));

		newChildDescriptors.add(createChildParameter(AssemblyViewPointPackage.Literals.SYSTEM__SYSTEM_ELEMENTS,
				AssemblyViewPointFactory.eINSTANCE.createRole()));

		newChildDescriptors.add(createChildParameter(AssemblyViewPointPackage.Literals.SYSTEM__SYSTEM_ELEMENTS,
				AssemblyViewPointFactory.eINSTANCE.createDelegationConnector()));

		newChildDescriptors.add(createChildParameter(AssemblyViewPointPackage.Literals.SYSTEM__SYSTEM_ELEMENTS,
				AssemblyViewPointFactory.eINSTANCE.createAssemblyConnector()));
	}
