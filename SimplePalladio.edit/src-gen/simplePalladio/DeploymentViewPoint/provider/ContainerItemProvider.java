...
/**
 * This is the item provider adapter for a {@link simplePalladio.DeploymentViewPoint.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainerItemProvider extends AbstractEnvironmentElementItemProvider {
	/**
	...
	protected void addLinksPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Container_links_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Container_links_feature",
								"_UI_Container_type"),
						DeploymentViewPointPackage.Literals.CONTAINER__LINKS, true, false, true, null, null, null));
	}
