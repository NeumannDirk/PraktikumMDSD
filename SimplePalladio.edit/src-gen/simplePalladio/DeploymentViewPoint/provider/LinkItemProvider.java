...
/**
 * This is the item provider adapter for a {@link simplePalladio.DeploymentViewPoint.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider extends AbstractEnvironmentElementItemProvider {
	/**
	...
	protected void addContainersPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Link_containers_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Link_containers_feature", "_UI_Link_type"),
						DeploymentViewPointPackage.Literals.LINK__CONTAINERS, true, false, true, null, null, null));
	}
