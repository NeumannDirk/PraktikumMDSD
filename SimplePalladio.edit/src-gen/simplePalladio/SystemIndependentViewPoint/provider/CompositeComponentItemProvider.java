...
/**
 * This is the item provider adapter for a {@link simplePalladio.SystemIndependentViewPoint.CompositeComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeComponentItemProvider extends AbstractComponentItemProvider {
	/**
	...
	protected void addSystemPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_CompositeComponent_system_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_CompositeComponent_system_feature",
								"_UI_CompositeComponent_type"),
						SystemIndependentViewPointPackage.Literals.COMPOSITE_COMPONENT__SYSTEM, true, false, true, null,
						null, null));
	}
