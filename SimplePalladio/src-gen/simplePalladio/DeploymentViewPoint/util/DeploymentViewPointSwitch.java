 ...
 * @generated
 */
public class DeploymentViewPointSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public DeploymentViewPointSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DeploymentViewPointPackage.CONTAINER: {
			...
			if (result == null)
				result = caseAbstractEnvironmentElement(container);
			if (result == null)
		...
		case DeploymentViewPointPackage.LINK: {
			...
			if (result == null)
				result = caseAbstractEnvironmentElement(link);
			if (result == null)
		...
		case DeploymentViewPointPackage.ABSTRACT_ENVIRONMENT_ELEMENT: {
			AbstractEnvironmentElement abstractEnvironmentElement = (AbstractEnvironmentElement) theEObject;
			T result = caseAbstractEnvironmentElement(abstractEnvironmentElement);
			if (result == null)
				result = caseNamedElement(abstractEnvironmentElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Environment Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Abstract Environment Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAbstractEnvironmentElement(AbstractEnvironmentElement object) {
		return null;
	}
