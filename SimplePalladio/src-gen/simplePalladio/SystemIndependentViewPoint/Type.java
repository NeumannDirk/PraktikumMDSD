 ...
 * <!-- end-user-doc -->
 * @see simplePalladio.SystemIndependentViewPoint.SystemIndependentViewPointPackage#getType()
 * @model
 * @generated
 */
public enum Type implements Enumerator {
	 ...
	 * @generated
	 */
	private static final Type[] VALUES_ARRAY = new Type[] { VOID, BOOLEAN, CHAR, DATE, DOUBLE, FLOAT, LIST, INT, LONG,
			MAP, STRING, };
