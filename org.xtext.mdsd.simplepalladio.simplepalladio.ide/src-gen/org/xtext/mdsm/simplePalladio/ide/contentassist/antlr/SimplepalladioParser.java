...
public class SimplepalladioParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SimplepalladioGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModelAccess().getRepositoryViewType2Assignment_3(), "rule__Model__RepositoryViewType2Assignment_3");
			builder.put(grammarAccess.getModelAccess().getAssemblyViewType2Assignment_4(), "rule__Model__AssemblyViewType2Assignment_4");
			builder.put(grammarAccess.getModelAccess().getEnvironmentViewTypeAssignment_5(), "rule__Model__EnvironmentViewTypeAssignment_5");
			builder.put(grammarAccess.getModelAccess().getAllocationViewTypeAssignment_6(), "rule__Model__AllocationViewTypeAssignment_6");
			...
			builder.put(grammarAccess.getDelegationConnectorAccess().getInterfaceAssignment_6(), "rule__DelegationConnector__InterfaceAssignment_6");
